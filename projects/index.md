# Projects Index — The Historiotheque

*Every repository in the organization, its purpose, and its status.
A project gets its own repo only when it needs its own release stream and DOIs;
everything else lives as a directory under this repo's `projects/` folder.*
