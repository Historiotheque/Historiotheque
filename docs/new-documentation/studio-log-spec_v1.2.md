# Historiotheque Studio Log — Format Specification v1.2
...
**On the qualitative season:** the moral-temperature reading (Seasons of the Heart) is no
longer a frontmatter field. When it matters to the session, write it in the log body in
