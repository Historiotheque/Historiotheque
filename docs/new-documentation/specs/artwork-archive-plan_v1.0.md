...
├── images/
│   ├── index.md                 # the image stream
│   └── chronotopium-series/
│       ├── index.md             # series overview + work list
│       └── no-11/
│           ├── work.md          # full metadata (frontmatter below; universal template)
│           └── no-11_web.jpg    # optional display copy (web image / audio preview / excerpt)
├── sounds/
│   └── index.md
└── texts/
    └── index.md
...
stream: images                  # images | sounds | texts
series: chronotopium-series
date: 2026-09-18
medium: "mixed media on cardboard"     # or "digital painting"
dimensions_physical: "60 x 45 cm"      # images (analog) only
dimensions_px: "6000x4500"             # images (digital) only
duration: "12:34"                      # sounds only
extent: "240 pages"                    # texts only
master_location: "https://archive.org/details/historiotheque-chronotopium-no11-2026"
display_copy: "no-11_web.jpg"           # optional; omit if documenting only
