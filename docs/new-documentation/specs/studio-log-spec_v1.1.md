# Historiotheque Studio Log — Format Specification v1.1
...
season_of_heart: summer-solemn      # optional qualitative season (Seasons of the Heart); blank if unknown
...
- `season_of_heart`: the *qualitative* season — the moral temperature reading, in kebab-case,
  from the Seasons of the Heart vocabulary: `autumn-of-atonement`, `summer-of-the-heart`,
  `winter-of-the-soul`, `springtime-of-life`, `summer-cool`, `summer-solemn`, … Open-ended;
  new names are coined as the work calls for them. **Optional — leave blank when unknown.**
  Asked every time a log is drafted. It is *not* tied to the calendar season and may change
  within a day (a solemn-summer morning can precede a winter-of-the-soul evening). This is
  the field that makes each log a recording surface for the Seasons of the Heart project,
  which runs across all disciplines inside the Painter's Almanach.
